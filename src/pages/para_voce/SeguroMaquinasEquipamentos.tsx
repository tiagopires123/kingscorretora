            ...
            <div className='main-container'>
                ...
                <div className='box'>
                    <div className='box-text'>
                        ...
                        <p>b) equipamentos móveis – são os equipamentos que operam por autopropulsão, deslocando-se por seus próprios meios, em canteiros de obras, entre locais de trabalho ou viagem de entrega.</p>
                    </div>
